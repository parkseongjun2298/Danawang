...
decode_key = "bsE5AeiHGFzKvS7n2oM6rZ8IQEOVLh/O8gKrORcpl3fl2ut8D2TfLcTIbYTmwFOvj3tCfdUBxigtsKCz16bNwA=="
...
def LoadXML():
	serverUrl = "http://openapi.price.go.kr/openApiImpl/ProductPriceInfoService/getProductInfoSvc.do?ServiceKey="
	#serverValue = ""
	areaData = openAPItoXML(serverUrl, decode_key)	
...
def getParsingData(xmlData, motherData):
...
def Please():
	serverUrl = "http://openapi.price.go.kr/openApiImpl/ProductPriceInfoService/getProductInfoSvc.do?ServiceKey="
	serverValue = ""
	areaData = openAPItoXML(serverUrl, decode_key, serverValue)
	req = (getParsingData(areaData, "item"))
...
def SearchResultRenderText():
    ...
    RenderText = Label(g_Tk, width=50, height=9, borderwidth=6, relief='ridge')
    RenderText.pack()
